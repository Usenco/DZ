...
const char * Date::getSMonth(const char * lan)
{
	...
	if (strcmp(lan, "RU") == 0) {
		switch (month)
		{
		case 1: strcpy_s(tmp, 20, "ÿíâàðü"); break;
		case 2: strcpy_s(tmp, 20, "ôåâðàëü"); break;
		case 3: strcpy_s(tmp, 20, "ìàðò"); break;
		case 4: strcpy_s(tmp, 20, "àïðåëü"); break;
		case 5: strcpy_s(tmp, 20, "ìàé"); break;
		case 6: strcpy_s(tmp, 20, "èþíü"); break;
		case 7: strcpy_s(tmp, 20, "èþëü"); break;
		case 8: strcpy_s(tmp, 20, "àâãóñò"); break;
		case 9: strcpy_s(tmp, 20, "ñåíòÿáðü"); break;
		case 10: strcpy_s(tmp, 20, "îêòÿáðü"); break;
		case 11: strcpy_s(tmp, 20, "íîÿáðü"); break;
		case 12: strcpy_s(tmp, 20, "äåêàáðü"); break;
		}
	}
